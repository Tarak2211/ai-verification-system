...
SECRET_KEY = 'django-insecure-)_$o%h%&dln@94i=bq7h#eia3mxc4(2b$4(h%owh#ozxl)hvh4'
...
AUTH_PASSWORD_VALIDATORS = [
    ...
    {
        'NAME': 'accounts.validators.MinMaxLengthValidator',
        'OPTIONS': {
            'min_length': 8,
            'max_length': 128,
        }
    ...
    {
        'NAME': 'accounts.validators.AlphanumericSpecialPasswordValidator',
    },
    {
        'NAME': 'accounts.validators.UsernameNotInPasswordValidator',
    },
    {
...
PASSWORD_RESET_TIMEOUT = 1800  # 30 minutes in seconds (30 * 60)
...
# DEVELOPMENT MODE: Emails printed to console
EMAIL_BACKEND = 'django.core.mail.backends.console.EmailBackend'

# PRODUCTION MODE: Uncomment below and configure with your email settings
...
# Default from email
DEFAULT_FROM_EMAIL = 'UserHub Pro <noreply@userhubpro.com>'
